...
namespace godot
{
    ...
    public:
        template <iree_hal_element_type_t>
        struct StorageType;
    ...
    template <>
    struct IREETensor::StorageType<IREE_HAL_ELEMENT_TYPE_UINT_8>
    {
        using type = PackedByteArray;
        static constexpr int64_t element_size = 1; // In bytes.
    };
    template <>
    struct IREETensor::StorageType<IREE_HAL_ELEMENT_TYPE_FLOAT_32>
    {
        using type = PackedFloat32Array;
        static constexpr int64_t element_size = 4; // In bytes.
    };
    template <>
    struct IREETensor::StorageType<IREE_HAL_ELEMENT_TYPE_FLOAT_64>
    {
        using type = PackedFloat64Array;
        static constexpr int64_t element_size = 8; // In bytes.
    };
    template <>
    struct IREETensor::StorageType<IREE_HAL_ELEMENT_TYPE_SINT_32>
    {
        using type = PackedInt32Array;
        static constexpr int64_t element_size = 4; // In bytes.
    };
    template <>
    struct IREETensor::StorageType<IREE_HAL_ELEMENT_TYPE_SINT_64>
    {
