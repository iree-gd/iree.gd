...
IREEDevice::IREEDevice(IREEDevice &p_iree_device) : hal_device(p_iree_device.hal_device),
...
// Vulkan (Windows, Linux, *BSD)
    ...
    { // Not using vulkan, create vulkan device ourselves.
        iree_hal_driver_t *driver = nullptr;
    ...
    { // Godot is using vulkan, wrap vulkan.
