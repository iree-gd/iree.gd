...
IREEDevice::IREEDevice() :
		hal_device(nullptr), hal_module(nullptr) {}
...
// Vulkan (Windows, Linux, *BSD)
	...
	create_clean_up_driver:
		...
		driver_options.requested_features =
				(iree_hal_vulkan_features_t)(IREE_HAL_VULKAN_FEATURE_ENABLE_DEBUG_UTILS);
...
iree_hal_device_t *IREEDevice::borrow_hal_device() const { return hal_device; }

iree_vm_module_t *IREEDevice::borrow_hal_module() const { return hal_module; }
