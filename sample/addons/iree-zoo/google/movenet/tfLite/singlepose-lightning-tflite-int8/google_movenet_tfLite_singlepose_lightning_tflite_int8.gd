...
func _load_module() -> IREEModule:
	match OS.get_name():
		"Windows", "Linux", "FreeBSD", "NetBSD", "OpenBSD", "BSD":
			return IREEModule.new().load("res://addons/iree-zoo/google/movenet/tfLite/singlepose-lightning-tflite-int8/iree.vulkan-spirv.vmfb")
		"macOS", "iOS":
			return IREEModule.new().load("res://addons/iree-zoo/google/movenet/tfLite/singlepose-lightning-tflite-int8/iree.metal-spirv.vmfb")
		"Android":
			return IREEModule.new().load("res://addons/iree-zoo/google/movenet/tfLite/singlepose-lightning-tflite-int8/iree.llvm-cpu.vmfb")
		_:
